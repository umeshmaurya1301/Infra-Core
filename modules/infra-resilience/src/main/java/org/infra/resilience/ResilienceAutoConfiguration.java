package org.infra.resilience;

import org.infra.resilience.breaker.CircuitBreakerMetrics;
import org.infra.resilience.bulkhead.Bulkhead;
import org.infra.resilience.bulkhead.BulkheadMetrics;
import org.infra.resilience.bulkhead.SemaphoreBulkhead;
import org.infra.resilience.bulkhead.ThreadPoolBulkhead;
import org.infra.resilience.breaker.CircuitBreakers;
import org.infra.resilience.deadline.CallDecorator;
import org.infra.resilience.deadline.ContextPropagatingCallDecorator;
import org.infra.resilience.deadline.DeadlineExecutor;
import org.infra.resilience.deadline.DeadlineFilter;
import org.infra.resilience.deadline.DeadlinePropagation;
import org.infra.resilience.ratelimit.EndpointCosts;
import org.infra.resilience.ratelimit.EndpointRateLimiter;
import org.infra.resilience.ratelimit.RateLimitMetrics;
import org.infra.resilience.ratelimit.RateLimiter;
import org.infra.resilience.ratelimit.RateLimiters;
import org.infra.resilience.ratelimit.ReadModifyWriteRateLimiter;
import org.infra.resilience.ratelimit.RedisTokenBucketRateLimiter;
import org.infra.resilience.ratelimit.UnlimitedRateLimiter;
import org.infra.resilience.retry.Backoff;
import org.infra.resilience.retry.FailureClassifier;
import org.infra.resilience.retry.RetryBudget;
import org.infra.resilience.retry.RetryMetrics;
...
public class ResilienceAutoConfiguration {
    ...
    public static class RateLimiterConfiguration {
        ...
        public org.infra.resilience.lock.RedisLock redisLock(StringRedisTemplate redis) {
            return new org.infra.resilience.lock.RedisLock(redis, "payorch:lock");
        }
